...
public sealed class EmailService : IEmailService
{
    ...
    private static readonly System.Text.CompositeFormat SandboxEndpointTemplate =
        System.Text.CompositeFormat.Parse("https://sandbox.api.mailtrap.io/api/send/{0}");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await SendViaMailtrapAsync(recipient, subject, templateName, variables, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            var endpoint = sandbox
                ? string.Format(System.Globalization.CultureInfo.InvariantCulture, SandboxEndpointTemplate, _options.TestInboxId)
                : ProductionEndpoint;
