...
{
    private static readonly string[] OperationLabel = { "operation" };
    private static readonly string[] OperationStatusLabels = { "operation", "status" };
    private static readonly double[] DurationBuckets = { 0.0001, 0.0005, 0.001, 0.005, 0.01, 0.025, 0.05, 0.1 };
    ...
    public CacheMetrics(string prefix = "")
    {
        ...
        OperationsTotal = Prometheus.Metrics.CreateCounter(
            ...
            new CounterConfiguration { LabelNames = OperationStatusLabels });
