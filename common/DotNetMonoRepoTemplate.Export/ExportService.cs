...
{
    public Task<byte[]> ExportToBufferAsync<T>(
    ...
    public async Task<byte[]> StreamExportAsync<T>(
    ...
    public string GetFileExtension(ExportFormat format) => format == ExportFormat.Csv ? ".csv" : ".xlsx";
}
