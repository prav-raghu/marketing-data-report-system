...
{
    private static readonly HashSet<string> SkipUrls = new(StringComparer.OrdinalIgnoreCase) { "/ping", "/ready" };
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        _logger.Info(
            "Incoming request",
            new Dictionary<string, object?> { ["method"] = context.Request.Method, ["url"] = path, ["correlationId"] = correlationId });
