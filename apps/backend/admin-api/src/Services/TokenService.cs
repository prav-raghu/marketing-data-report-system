...
public sealed class TokenService
{
    ...
    private readonly SymmetricSecurityKey _mfaChallengeKey;
    ...
    public TokenService(AdminApiOptions options, IConnectionMultiplexer redis)
    {
        ...
        _mfaChallengeKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(options.MfaChallengeSecret));
    ...
    public TokenPair GenerateToken(User user, bool rememberMe, string roleName)
    {
        ...
        var accessToken = CreateToken(
            user.Id, user.Username, roleName, permissions, TokenScope.Admin, accessTokenId, "access", _accessKey, _accessTokenExpiry);
    ...
    public string GenerateMfaChallengeToken(string userId)
    {
        ...
        var credentials = new SigningCredentials(_mfaChallengeKey, TokenAlgorithm);
        ...
        try
        {
            ...
            var principal = handler.ValidateToken(
                ...
                new TokenValidationParameters
                {
                    ...
                    IssuerSigningKey = _mfaChallengeKey,
