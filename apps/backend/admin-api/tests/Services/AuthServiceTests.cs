...
public sealed class AuthServiceTests
{
    ...
    public async Task LoginAsync_ReturnsTokens_WhenCredentialsAreValidAndMfaIsDisabled()
    {
        ...
        var service = BuildService(db, new ConnectedRedisTestDouble().Multiplexer);
    ...
    public async Task VerifyLoginMfaAsync_ReturnsTokens_WhenChallengeAndCodeAreValid()
    {
        ...
        var service = new AuthService(db, tokenService, _emailService.Object, userService, new ConnectedRedisTestDouble().Multiplexer.Object, TestOptions.AdminApi());
