...
public sealed class WebhookSubscriptionService
{
    ...
    public async Task<WebhookOperationResult<WebhookSubscription>> CreateSubscriptionAsync(
        CreateWebhookSubscriptionDto dto,
        string? createdBy,
        CancellationToken cancellationToken = default)
    {
        var secret = string.IsNullOrEmpty(dto.Secret) ? _signatureService.GenerateSecret() : dto.Secret;
        ...
        return new WebhookOperationResult<WebhookSubscription> { IsSuccessful = true, Data = subscription };
    }

    public async Task<WebhookOperationResult<WebhookSubscription>> GetSubscriptionAsync(
        string id,
        string userId,
        CancellationToken cancellationToken = default)
    {
        ...
        return subscription is null
            ? new WebhookOperationResult<WebhookSubscription> { IsSuccessful = false, Message = SubscriptionNotFound }
            : new WebhookOperationResult<WebhookSubscription> { IsSuccessful = true, Data = subscription };
    }

    public async Task<WebhookOperationResult<IReadOnlyList<WebhookSubscription>>> ListSubscriptionsAsync(
        string userId,
        bool? isActive,
        CancellationToken cancellationToken = default)
    {
        ...
        return new WebhookOperationResult<IReadOnlyList<WebhookSubscription>> { IsSuccessful = true, Data = subscriptions };
    }

    public async Task<WebhookOperationResult<WebhookSubscription>> UpdateSubscriptionAsync(
        string id,
        string userId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return new WebhookOperationResult<WebhookSubscription> { IsSuccessful = false, Message = SubscriptionNotFound };
        }
    ...
    public async Task<WebhookOperationResult<IReadOnlyList<WebhookDelivery>>> GetDeliveriesAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (subscription is null)
        {
            return new WebhookOperationResult<IReadOnlyList<WebhookDelivery>>
            {
                IsSuccessful = false,
                Data = Array.Empty<WebhookDelivery>(),
        ...
        return new WebhookOperationResult<IReadOnlyList<WebhookDelivery>> { IsSuccessful = true, Data = deliveries };
    }

    public async Task<WebhookOperationResult<WebhookSubscription>> RegenerateSecretAsync(
        string id,
        string userId,
        CancellationToken cancellationToken = default)
    {
        ...
        subscription.Secret = _signatureService.GenerateSecret();
        subscription.ModifiedBy = userId;
        await _db.SaveChangesAsync(cancellationToken);
