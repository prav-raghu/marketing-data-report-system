...
public sealed class HealthService
{
    ...
    private static readonly long ProcessStartTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
    ...
    public static double UptimeSeconds =>
        System.Diagnostics.Stopwatch.GetElapsedTime(ProcessStartTimestamp).TotalSeconds;
